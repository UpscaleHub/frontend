        ...
        <div className="bg-whit border border-white/25  bg-clip-padding backdrop-filter backdrop-blur-sm  p-8 rounded-2xl shadow-md w-full max-w-md space-y-6 paragraph">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full cursor-pointer header bg-gradient-to-b to-blue-400 from-cyan-400  text-white py-2 rounded-full hover:bg-[#1b3c3a] transition font-medium disabled:opacity-50"
            >
